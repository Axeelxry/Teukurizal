...
export const Timeline = ({ children }: { children: React.ReactNode }) => {
  return (
    ...
    />
      ...
      <SectionHeader
        title="Experience"
        content="Saya memperoleh pengalaman kerja berharga sebagai Kepala Warehouse, Repair. sebelum saya melanjutkan ke pendidikan lebih tinggi. Berikut ini adalah ringkasan pekerjaan saya dan keterampilan yang telah saya kembangkan selama ini."
      />
